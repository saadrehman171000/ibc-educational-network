...
export default function AddCollectionPage() {
  ...
  const categories = ["Mathematics", "English", "Science", "Social Studies", "Mixed"]
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        <Link href="/admin/collections" className="p-2 hover:bg-gray-100 rounded-lg">
          <ArrowLeft className="w-5 h-5" />
        </Link>
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Add New Collection</h1>
          <p className="text-gray-600">Create a new educational collection</p>
        </div>
      </div>
